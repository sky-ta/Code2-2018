...
function setup() {
  ...
  ghost.addAnimation("normal", "./assets/16-A03-1.png",  "./assets/16-A03-4.png");
  
  asterisk = createSprite(200, 200);  
  asterisk.addAnimation("normal", "./assets/16-A03-1.png", "./assets/16-A03-4.png");
  asterisk.addAnimation("stretch", "./assets/16-A03-1.png", "./assets/16-A03-4.png");
  
  //if defined, the collider will be used for mouse events
  asterisk.setCollider("circle", 0,0,64);
  
  platform = createSprite(200, 300);
  platform.addAnimation("normal", "./assets/16-A03-1.png",  "./assets/16-A03-4.png");
}
